...
<div class="content overlay" 
    style="background-image: url(<?php echo $data['certificate']->background_image; ?>)">

    <div class="qrcode-container" data-cert="<?php echo e($data['certificate']); ?>"> 
      <!-- <img src="https://upload.wikimedia.org/wikipedia/commons/d/d0/QR_code_for_mobile_English_Wikipedia.svg"> -->
      <img src="<?php echo e($data['certificate']->qrcode); ?>">
    </div>
    ...
    <div class="inner-container">
        ...
        <p>IS PRESENTED TO:</p>
        <h1 class="participant-name"><?php echo e($data['certificate']->user_name); ?></h1>
        <p class="underline">___________________________________________________________</p>
        <p>For completing the <strong><?php echo e($data['certificate']->category); ?></strong> with the event <br>
        ...
        <br>
        <p>" <?php echo $data['certificate']->quote; ?> "</p>
        <table>
            <tr class="">
                ...
                <td class="text-center spacer">
                  <img id="signature" src="<?php echo e($data['certificate']->user_signature); ?>" alt="Signature" style="width: 220px; height: 70px;z-index: 1;margin-top: 15px;">
                </td>
                <td class="text-center spacer">&nbsp;</td>
            </tr>
            <tr class="">
...
</html><?php /**PATH C:\wamp64\www\smartserminar-suit\resources\views/pdf/ai/view.blade.php ENDPATH**/ ?>