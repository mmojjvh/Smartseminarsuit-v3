                ...
                <div class="swiper-slide fit">
                    <div class="slider-wrapper">
                        <div class="background-wrapper" data-swiper-parallax="20%">
                            <div data-pages-bg-image="<?php echo e(asset('images/bg-hero.jpg')); ?>" draggable="false" class="background"></div>
                        </div>
                    </div>
                                ...
                                <div class="col-xs-height col-middle text-left">
                                    <div class="container">
                                        <div class="col-md-6 col-sm-10 col-sm-offset-1 col-xs-10 col-xs-offset-1 p-l-40 sm-no-padding" data-pages-animation="standard" data-type="transition.slideDownIn" data-duration="600" data-delay="1000" data-md-type="">
                                            ...
                                            <p class="fs-12 text-white hint-text sm-text-center">Get certified now!</p>
                                        </div>
                                    </div>
                                </div>
                            </div>
...
<?php /**PATH C:\Users\markj\OneDrive\Desktop\Capstone 2\smartserminar-suit 1.0 (1)\smartserminar-suit\resources\views/frontend/web/_sections/banner.blade.php ENDPATH**/ ?>