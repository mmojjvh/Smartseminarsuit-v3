                                  ...
                                  <tbody>
                                    <?php $__empty_1 = true; $__currentLoopData = $participants; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $index => $participant): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                                      <tr class="hover-primary">
                                          ...
                                          <?php if(!$participant->timeout): ?>
                                          <td><span class="badge badge-primary">Present</span></td>
                                          <?php else: ?>
                                          <td>
                                            <strong>Signed Out</strong> : <br /><?php echo e($participant->timeout?date('M d, Y @ h:i a', strtotime($participant->timeout)):'---'); ?>
...
<?php echo $__env->make('backoffice._layout.main', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /Users/bpaltezo/Desktop/Smartseminarsuit-v3/resources/views/backoffice/pages/attendance/participants.blade.php ENDPATH**/ ?>