...
<div id="pageBody" class="page-body" style="display: none;">
...
<div class="content overlay <?php echo e($loop->last?'':'page-break'); ?>">

    <div class="qrcode-container" data-cert="<?php echo e($certificate); ?>">
    ...
    <div class="inner-container">
        ...
        <p>IS PRESENTED TO:</p>
        <h1 class="participant-name"><?php echo e($certificate->user_name); ?></h1>
        <p class="underline">___________________________________________________________</p>
        <p>For completing the <strong><?php echo e($certificate->category); ?></strong> with the event <br>
        ...
        <br>
        <p>" <?php echo $certificate->quote; ?> "</p>
        <table>
            <tr class="">
                <td class="text-center "></td>
                <td class="text-center spacer">&nbsp;</td>
                <td class="text-center spacer">&nbsp;</td>
                <!-- <td class="text-center "><strong><?php echo e($certificate->date?date('m-d-Y', strtotime($certificate->date)):'---'); ?></strong></td> -->
                <td class="text-center spacer">
                  ...
                  <img id="signature" src="<?php echo e($certificate->user_signature); ?>" alt="Signature" style="width: 220px; height: 70px;z-index: 1;margin-top: 15px;">
                </td>
            </tr>
            <tr class="">
...
async function generateCertificateBackground() {
  try {
    ...
    const response = await fetch(corsBypasser + 'https://api.openai.com/v1/images/generations', {
        method: 'POST',
        headers: {
...
async function generateCertificatex() {
  ...
  async function generateCertificate() {
    ...
    $(".content").map((index, container) => {
        $(container).css('backgroundImage', `url(${backgroundUrl})`)
    });
  ...
  //   container.style.backgroundImage = 'url(https://img.freepik.com/free-vector/blue-certificate-background-gold-modern-border-vector_53876-156358.jpg)';
  //   console.log(container, container.style.backgroundImage)
  // }
  ...
  <!-- style="background-image: url(<?php echo $certificate->directory.'/'.$certificate->filename; ?>)" --><?php /**PATH C:\wamp64\www\smartserminar-suit\resources\views/pdf/ai/all.blade.php ENDPATH**/ ?>