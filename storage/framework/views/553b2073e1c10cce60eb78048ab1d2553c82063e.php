                                  ...
                                  <tbody>
                                    <?php $__empty_1 = true; $__currentLoopData = $feedbacks; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $index => $feedback): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                                      <tr class="hover-primary">
                                          ...
                                          <td><?php echo e(Str::limit($feedback->question, 100)); ?></td>
                                          <td><?php echo e(Str::limit($feedback->comment, 100)); ?></td>
                                      </tr>
...
<?php echo $__env->make('backoffice._layout.main', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\wamp64\www\Smartseminarsuit-v3\resources\views/backoffice/pages/feedbacks/index.blade.php ENDPATH**/ ?>