  ...
  <div id="pageBody" class="certificate background" style="background: url(<?php echo $data['certificate']->background_image; ?>);"> 
    ...
    <div class="main">
      ...
      <center class="content">
        ...
        <p class="details">For completing the event title of "<strong><?php echo e(Str::title($data['certificate']->event_name)); ?></strong>" that was held on <strong><?php echo e($data['certificate']->date?date('M d, Y', strtotime($data['certificate']->date)):'---'); ?>.</strong></p>
        <br />
        ...
        <table class="signatures-table">
          <tr>
            <!-- <td>
              ...
              <br>
              <span class="name"><?php echo e($data['certificate']->user_name); ?></span>
