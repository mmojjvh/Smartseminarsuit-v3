                      ...
                      <div class="box-body overflow-auto">
                          <div class="row">
                            <div class="col-md-4">
                                ...
                                <input type="text" name="search" value="{{Input::has('search')?Input::get('search'):''}}" class="form-control pull-right" placeholder="Search for a Service...">
                                </form>
                            </div>
                            <div class="col-md-4 offset-md-4">
                                <a href="{{route('backoffice.services.create')}}" class="waves-effect waves-light btn btn-outline btn-primary mb-5 pull-right">Create New</a>
                            </div>
                          </div>
                                          ...
                                          <td>												
                                              <div class="btn-group">
                                                ...
                                                <div class="dropdown-menu">
                                                  <a class="dropdown-item" href="{{route('backoffice.services.edit', $service->id)}}">Edit</a>
