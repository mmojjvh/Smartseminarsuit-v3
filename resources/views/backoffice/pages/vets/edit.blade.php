...
@push('title','Edit '.$title.' Information')
                    ...
                    <div class="d-inline-block align-items-center">
                        <nav>
                            <ol class="breadcrumb">
                                ...
                                <li class="breadcrumb-item active" aria-current="page">Edit {{$title}} Information</li>
                            </ol>
                        </nav>
                    </div>
                </div>
                ...
                <div class="col-md-6">
                    ...
                    <div class="box">
                        <div class="box-header with-border">
                            <h4 class="box-title">Edit Service Information</h4>
                        </div>
                        <!-- /.box-header -->
                        @include('backoffice.pages.vets.form')
                    </div>
                </div>
            </div>
        </section>
