...
<div class="content overlay {{ $loop->last?'':'page-break' }}" 
    ...
    <div class="inner-container">
        ...
        <p style="font-size: 13pt;text-align: center;">For completing the <strong>{{ $certificate->category }}</strong> with the event <br>
        ...
        <br>
        <p style="font-size: 12pt;">" {!!$certificate->quote!!} "</p>
        <table>
            <tr class="">
